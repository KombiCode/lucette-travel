...
trip2 = Trip.create(
  ...
  country: "Iceland",
  city: "Reykjavík",
  begin_date: Date.new(2022, 4, 10),
  end_date: Date.new(2022, 4, 17),
  language: "English",
  devise: "€",
  user: user2,
  photo_title: "iceland",
...
plane1 = Booking.create(
  ...
  #begin_date: "23/03/2022, 11h50",
  #end_date: "24/03/2022, 1h05",
  price: 263.40,
